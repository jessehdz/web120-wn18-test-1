...
#EDIT THE FOLLOWING:
$toAddress = "jessi.hernandez@seattlecentral.edu";  //place your/your client's email address here
$toName = "Jesse Hernandez"; //place your client's name here
...
if ($response != null && $response->success)
    ...
    <div class="contact-feedback">
        <h2>Thank you for your interest in our web services!</h2>
        
        <p>We will get back to you in two business days.</p>
    </div>    
    <!-- END HTML FEEDBACK -->        
    <?php
...
?>
	...
	<div>	
		<fieldset>
			<legend>What Web Services Interest You?</legend>
			...
			<input type="checkbox" name="Interested_In[]" value="Social Media" /> Social Media <br />
		...
		<fieldset>
			...
			required="required" title="Mailing list is required" tabindex="50" checked="checked"
			/> Yes <br />
